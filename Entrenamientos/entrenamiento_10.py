...
class GeneracionDatasetEntrenamiento(Dataset):
    ...
    def __init__(self, imageFolderDataset, transform=None, should_invert=True):
        ...
        self.list_img0 = fichero_train['Img0']
        self.list_img1 = fichero_train['Img1']
        self.label = fichero_train['Label']
...
with open(PARAMETERS.base_dir + PARAMETERS.data_csv_dir, 'w', newline='') as file:
    ...
    for epoch in range(0, PARAMETERS.train_number_epochs):
        for i, data in enumerate(train_dataloader, 0):
            ...
            loss_contrastive.backward()   # triplet_loss = criterion(output1,output2,output3)
            ...
            if i % PARAMETERS.do_validation == 0:
                ...
                if accuracy >= max_accuracy and accuracy > PARAMETERS.min_val_accuracy:
                    ...
                    print("Nº de combinaciones de imágenes cargadas: ", ((i+1)*PARAMETERS.train_batch_size)+epoch*len(img0))
                    ...
                    writer.writerow([epoch, i+1, ((i+1)*PARAMETERS.train_batch_size)+epoch*len(img0), accuracy_loss*100/PARAMETERS.num_iteraciones, max_accuracy, sum_time_train, sum_time_val])
