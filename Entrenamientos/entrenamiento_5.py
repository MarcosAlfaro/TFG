...
def show_plot(iteration,loss,iteration_hard,loss_hard):
...
class GeneracionDatasetEntrenamiento(Dataset):
    ...
    def __init__(self, imageFolderDataset, transform=None, should_invert=True):
        ...
        self.list_index_pos = fichero_train['Index_pos']
        self.list_index_neg = fichero_train['Index_neg']
    ...
    def __getitem__(self, index):
        ...
        index_pos = self.list_index_pos[index]
        index_neg = self.list_index_neg[index]
        ...
        return anc, pos, neg, index_pos,index_neg
